...
const dailyEssentialCategories = ['All', 'Staples', 'Snacks', 'Beverages', 'Personal Care', 'Household'];
const categoryIcons = {
    'All': '🌐',
    'Staples': '🛒',
    'Snacks': '🍿',
...
const categoryToSubcategory = {
    'Staples': PRODUCT_SUBCATEGORIES.STAPLES,
    'Snacks': PRODUCT_SUBCATEGORIES.SNACKS,
    'Beverages': PRODUCT_SUBCATEGORIES.BEVERAGES,
    'Personal Care': PRODUCT_SUBCATEGORIES.PERSONAL_CARE,
    'Household': PRODUCT_SUBCATEGORIES.HOUSEHOLD
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <header className="sticky top-0 z-40 bg-white dark:bg-gray-800 border-b dark:border-gray-700">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
            <div className='flex items-center gap-2'>
                ...
                <h1 className="text-xl font-bold text-gray-800 dark:text-white">Daily Essentials</h1>
            </div>
      ...
      <div className="flex">
        ...
        <aside className="w-28 bg-gray-50 dark:bg-gray-800 h-full fixed top-16 left-0 overflow-y-auto pb-16">
          <nav>
            <ul>
              {dailyEssentialCategories.map((category, index) => (
                <li key={index}>
                  <button
